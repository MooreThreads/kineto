...
McclOpNameSet = ['mccl:broadcast', 'mccl:reduce', 'mccl:all_reduce', 'mccl:all_gather', 'mccl:reduce_scatter']
...
EventTypeMap = {
    ...
    # 'musa_driver': EventTypes.RUNTIME,
    'musa_runtime': EventTypes.RUNTIME,
...
def create_trace_event(event, is_pytorch_lightning) -> Optional[BaseEvent]:
    ...
    if event_type == EventTypes.USER_ANNOTATION:
        ...
        if name in GlooOpNameSet or name in McclOpNameSet:
