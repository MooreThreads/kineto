...
static constexpr std::array<ActivityTypeName, activityTypeCount + 1> map{{
    ...
    {"musa_runtime", ActivityType::MUSA_RUNTIME},
    {"musa_driver", ActivityType::MUSA_DRIVER},
    ...
    {"musa_sync", ActivityType::MUSA_SYNC},
    {"glow_runtime", ActivityType::GLOW_RUNTIME},
    {"mtia_runtime", ActivityType::MTIA_RUNTIME},
    {"musa_profiler_range", ActivityType::MUSA_PROFILER_RANGE},
